...
int main(int argc, char* argv[])
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
    setvideomode(0x13);
  11:	6a 13                	push   $0x13
  13:	e8 63 03 00 00       	call   37b <setvideomode>
  ...
  1d:	6a 64                	push   $0x64
  1f:	6a 00                	push   $0x0
  21:	e8 65 03 00 00       	call   38b <moveto>
    lineto(0, 200, 50);
  26:	83 c4 0c             	add    $0xc,%esp
  29:	6a 32                	push   $0x32
  2b:	68 c8 00 00 00       	push   $0xc8
  30:	6a 00                	push   $0x0
  32:	e8 5c 03 00 00       	call   393 <lineto>
    lineto(0, 200, 150);
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	68 96 00 00 00       	push   $0x96
  3f:	68 c8 00 00 00       	push   $0xc8
  44:	6a 00                	push   $0x0
  46:	e8 48 03 00 00       	call   393 <lineto>
    lineto(0, 100, 150);
  4b:	83 c4 0c             	add    $0xc,%esp
  4e:	68 96 00 00 00       	push   $0x96
  53:	6a 64                	push   $0x64
  55:	6a 00                	push   $0x0
  57:	e8 37 03 00 00       	call   393 <lineto>
    lineto(0, 100, 50);
  5c:	83 c4 0c             	add    $0xc,%esp
  5f:	6a 32                	push   $0x32
  61:	6a 64                	push   $0x64
  63:	6a 00                	push   $0x0
  65:	e8 29 03 00 00       	call   393 <lineto>
    getch();
  6a:	e8 04 03 00 00       	call   373 <getch>
    setvideomode(0x03);
  6f:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  76:	e8 00 03 00 00       	call   37b <setvideomode>
...
int stat(const char *n, struct stat *st) {
 ...
 21d:	e8 19 01 00 00       	call   33b <open>
    if (fd < 0) {
 ...
 231:	50                   	push   %eax
 232:	e8 cc 00 00 00       	call   303 <fstat>
    close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
    close(fd);
 23c:	e8 2a 01 00 00       	call   36b <close>
    return r;
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 41e:	56                   	push   %esi
 41f:	57                   	push   %edi
 420:	e8 1e ff ff ff       	call   343 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 495:	57                   	push   %edi
 496:	56                   	push   %esi
 497:	e8 a7 fe ff ff       	call   343 <write>
 ...
 4ee:	e8 50 fe ff ff       	call   343 <write>
                putc(fd, c);
 ...
 4ff:	57                   	push   %edi
 500:	56                   	push   %esi
 501:	e8 3d fe ff ff       	call   343 <write>
                putc(fd, c);
 ...
 5ac:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 5af:	e8 8f fd ff ff       	call   343 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 6e3:	e8 3b fc ff ff       	call   323 <sbrk>
    if (p == (char*)-1) {
