...
int main(int argc, char *argv[]) {
  ...
  32:	e8 04 03 00 00       	call   33b <link>
...
int stat(const char *n, struct stat *st) {
 ...
 1fd:	e8 19 01 00 00       	call   31b <open>
    if (fd < 0) {
 ...
 211:	50                   	push   %eax
 212:	e8 cc 00 00 00       	call   2e3 <fstat>
    close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
    close(fd);
 21c:	e8 2a 01 00 00       	call   34b <close>
    return r;
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 3fe:	56                   	push   %esi
 3ff:	57                   	push   %edi
 400:	e8 1e ff ff ff       	call   323 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 475:	57                   	push   %edi
 476:	56                   	push   %esi
 477:	e8 a7 fe ff ff       	call   323 <write>
 ...
 4ce:	e8 50 fe ff ff       	call   323 <write>
                putc(fd, c);
 ...
 4df:	57                   	push   %edi
 4e0:	56                   	push   %esi
 4e1:	e8 3d fe ff ff       	call   323 <write>
                putc(fd, c);
 ...
 58c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 58f:	e8 8f fd ff ff       	call   323 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 6c3:	e8 3b fc ff ff       	call   303 <sbrk>
    if (p == (char*)-1) {
