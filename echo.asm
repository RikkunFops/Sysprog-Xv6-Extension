...
int stat(const char *n, struct stat *st) {
 ...
 20d:	e8 19 01 00 00       	call   32b <open>
    if (fd < 0) {
 ...
 221:	50                   	push   %eax
 222:	e8 cc 00 00 00       	call   2f3 <fstat>
    close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
    close(fd);
 22c:	e8 2a 01 00 00       	call   35b <close>
    return r;
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 40e:	56                   	push   %esi
 40f:	57                   	push   %edi
 410:	e8 1e ff ff ff       	call   333 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 485:	57                   	push   %edi
 486:	56                   	push   %esi
 487:	e8 a7 fe ff ff       	call   333 <write>
 ...
 4de:	e8 50 fe ff ff       	call   333 <write>
                putc(fd, c);
 ...
 4ef:	57                   	push   %edi
 4f0:	56                   	push   %esi
 4f1:	e8 3d fe ff ff       	call   333 <write>
                putc(fd, c);
 ...
 59c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 59f:	e8 8f fd ff ff       	call   333 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 6d3:	e8 3b fc ff ff       	call   313 <sbrk>
    if (p == (char*)-1) {
