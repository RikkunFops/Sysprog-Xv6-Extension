...
int main(void)  {
  ...
  1d:	6a 05                	push   $0x5
  1f:	e8 b7 02 00 00       	call   2db <sleep>
...
000002b3 <fstat>:
SYSCALL(fstat)
 2b3:	b8 08 00 00 00       	mov    $0x8,%eax
 2b8:	cd 40                	int    $0x40
 2ba:	c3                   	ret    
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 3ce:	56                   	push   %esi
 3cf:	57                   	push   %edi
 3d0:	e8 1e ff ff ff       	call   2f3 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 445:	57                   	push   %edi
 446:	56                   	push   %esi
 447:	e8 a7 fe ff ff       	call   2f3 <write>
 ...
 49e:	e8 50 fe ff ff       	call   2f3 <write>
                putc(fd, c);
 ...
 4af:	57                   	push   %edi
 4b0:	56                   	push   %esi
 4b1:	e8 3d fe ff ff       	call   2f3 <write>
                putc(fd, c);
 ...
 55c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 55f:	e8 8f fd ff ff       	call   2f3 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 693:	e8 3b fc ff ff       	call   2d3 <sbrk>
    if (p == (char*)-1) {
