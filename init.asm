...
int main(void) {
  ...
  19:	e8 8d 03 00 00       	call   3ab <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 50 03 00 00       	call   383 <dup>
    dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 44 03 00 00       	call   383 <dup>
  ...
  e0:	e8 c6 02 00 00       	call   3ab <open>
...
int stat(const char *n, struct stat *st) {
 ...
 28d:	e8 19 01 00 00       	call   3ab <open>
    if (fd < 0) {
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 cc 00 00 00       	call   373 <fstat>
    close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
    close(fd);
 2ac:	e8 2a 01 00 00       	call   3db <close>
    return r;
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 1e ff ff ff       	call   3b3 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 a7 fe ff ff       	call   3b3 <write>
 ...
 55e:	e8 50 fe ff ff       	call   3b3 <write>
                putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 3d fe ff ff       	call   3b3 <write>
                putc(fd, c);
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 61f:	e8 8f fd ff ff       	call   3b3 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 753:	e8 3b fc ff ff       	call   393 <sbrk>
    if (p == (char*)-1) {
