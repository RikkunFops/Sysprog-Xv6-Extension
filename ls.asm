...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 e4 04 00 00       	call   5fb <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 8f 04 00 00       	call   5c3 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 d0 04 00 00       	call   62b <close>
 ...
 313:	e8 13 03 00 00       	call   62b <close>
    return;
...
int stat(const char *n, struct stat *st) {
 ...
 4dd:	e8 19 01 00 00       	call   5fb <open>
    if (fd < 0) {
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 cc 00 00 00       	call   5c3 <fstat>
    close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
    close(fd);
 4fc:	e8 2a 01 00 00       	call   62b <close>
    return r;
...
000005c3 <fstat>:
SYSCALL(fstat)
 5c3:	b8 08 00 00 00       	mov    $0x8,%eax
 5c8:	cd 40                	int    $0x40
 5ca:	c3                   	ret    
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 6de:	56                   	push   %esi
 6df:	57                   	push   %edi
 6e0:	e8 1e ff ff ff       	call   603 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 755:	57                   	push   %edi
 756:	56                   	push   %esi
 757:	e8 a7 fe ff ff       	call   603 <write>
 ...
 7ae:	e8 50 fe ff ff       	call   603 <write>
                putc(fd, c);
 ...
 7bf:	57                   	push   %edi
 7c0:	56                   	push   %esi
 7c1:	e8 3d fe ff ff       	call   603 <write>
                putc(fd, c);
 ...
 82b:	57                   	push   %edi
 82c:	56                   	push   %esi
 82d:	e8 d1 fd ff ff       	call   603 <write>
                while (*s != 0) {
 ...
 86c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 86f:	e8 8f fd ff ff       	call   603 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 9a3:	e8 3b fc ff ff       	call   5e3 <sbrk>
    if (p == (char*)-1) {
