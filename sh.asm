...
int main(void) {
    ...
    while ((fd = open("console", O_RDWR)) >= 0) {
      ...
      2b:	e8 5b 0e 00 00       	call   e8b <open>
...
int fork1(void) {
    ...
    if (buf[0] == 0) { // EOF
      ...
      b5:	50                   	push   %eax
      b6:	e8 00 0e 00 00       	call   ebb <close>
            break;
      ...
      e9:	c6 80 ff 19 00 00 00 	movb   $0x0,0x19ff(%eax)
            if (chdir(buf + 3) < 0) {
      f0:	e8 66 0d 00 00       	call   e5b <chdir>
...
void runcmd(struct cmd *cmd) {
    ...
    switch (cmd->type) {
     ...
     24a:	e8 6c 0c 00 00       	call   ebb <close>
            close(p[1]);
     24f:	58                   	pop    %eax
     ...
     286:	e8 30 0c 00 00       	call   ebb <close>
            if (open(rcmd->file, rcmd->mode) < 0) {
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 f3 0b 00 00       	call   e8b <open>
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 d8 0b 00 00       	call   ebb <close>
                dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 77 0b 00 00       	call   e63 <dup>
                close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 c6 0b 00 00       	call   ebb <close>
                close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 bd 0b 00 00       	call   ebb <close>
                runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 aa 0b 00 00       	call   ebb <close>
                dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 49 0b 00 00       	call   e63 <dup>
                close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 98 0b 00 00       	call   ebb <close>
                close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 8f 0b 00 00       	call   ebb <close>
                runcmd(pcmd->right);
     32c:	58                   	pop    %eax
...
int stat(const char *n, struct stat *st) {
    ...
    fd = open(n, O_RDONLY);
     ...
     d6d:	e8 19 01 00 00       	call   e8b <open>
    if (fd < 0) {
    ...
    r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 cc 00 00 00       	call   e53 <fstat>
    close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
    close(fd);
     d8c:	e8 2a 01 00 00       	call   ebb <close>
    return r;
...
00000e53 <fstat>:
SYSCALL(fstat)
     e53:	b8 08 00 00 00       	mov    $0x8,%eax
     e58:	cd 40                	int    $0x40
     e5a:	c3                   	ret    
...
00000e8b <open>:
SYSCALL(open)
     e8b:	b8 0f 00 00 00       	mov    $0xf,%eax
     e90:	cd 40                	int    $0x40
     e92:	c3                   	ret    
...
00000e9b <mknod>:
SYSCALL(mknod)
     e9b:	b8 11 00 00 00       	mov    $0x11,%eax
     ea0:	cd 40                	int    $0x40
     ea2:	c3                   	ret    

00000ea3 <unlink>:
SYSCALL(unlink)
     ea3:	b8 12 00 00 00       	mov    $0x12,%eax
     ea8:	cd 40                	int    $0x40
     eaa:	c3                   	ret    

00000eab <link>:
SYSCALL(link)
     eab:	b8 13 00 00 00       	mov    $0x13,%eax
     eb0:	cd 40                	int    $0x40
     eb2:	c3                   	ret    

00000eb3 <mkdir>:
SYSCALL(mkdir)
     eb3:	b8 14 00 00 00       	mov    $0x14,%eax
     eb8:	cd 40                	int    $0x40
     eba:	c3                   	ret    
...
00000ecb <setvideomode>:
SYSCALL(setvideomode)
...
static void printint(int fd, int xx, int base, int sgn) {
    ...
    write(fd, &c, 1);
     ...
     f6e:	56                   	push   %esi
     f6f:	57                   	push   %edi
     f70:	e8 1e ff ff ff       	call   e93 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
    ...
    write(fd, &c, 1);
     ...
     fe5:	57                   	push   %edi
     fe6:	56                   	push   %esi
     fe7:	e8 a7 fe ff ff       	call   e93 <write>
    ...
    103e:	e8 50 fe ff ff       	call   e93 <write>
                putc(fd, c);
    ...
    104f:	57                   	push   %edi
    1050:	56                   	push   %esi
    1051:	e8 3d fe ff ff       	call   e93 <write>
                putc(fd, c);
    ...
    10bb:	57                   	push   %edi
    10bc:	56                   	push   %esi
    10bd:	e8 d1 fd ff ff       	call   e93 <write>
                while (*s != 0) {
    ...
    write(fd, &c, 1);
    10ff:	e8 8f fd ff ff       	call   e93 <write>
                ap++;
...
void* malloc(uint nbytes) {
    ...
    1233:	e8 3b fc ff ff       	call   e73 <sbrk>
    if (p == (char*)-1) {
