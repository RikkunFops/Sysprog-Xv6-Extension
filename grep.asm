...
int main(int argc, char *argv[])     {
  ...
  55:	e8 01 06 00 00       	call   65b <close>
    for (i = 2; i < argc; i++) {
...
void grep(char *pattern, int fd) {
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 a2 03 00 00       	call   633 <write>
...
int stat(const char *n, struct stat *st) {
 ...
 50d:	e8 19 01 00 00       	call   62b <open>
    if (fd < 0) {
 ...
 521:	50                   	push   %eax
 522:	e8 cc 00 00 00       	call   5f3 <fstat>
    close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
    r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
    close(fd);
 52c:	e8 2a 01 00 00       	call   65b <close>
    return r;
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 70e:	56                   	push   %esi
 70f:	57                   	push   %edi
 710:	e8 1e ff ff ff       	call   633 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 785:	57                   	push   %edi
 786:	56                   	push   %esi
 787:	e8 a7 fe ff ff       	call   633 <write>
 ...
 7de:	e8 50 fe ff ff       	call   633 <write>
                putc(fd, c);
 ...
 7ef:	57                   	push   %edi
 7f0:	56                   	push   %esi
 7f1:	e8 3d fe ff ff       	call   633 <write>
                putc(fd, c);
 ...
 85b:	57                   	push   %edi
 85c:	56                   	push   %esi
 85d:	e8 d1 fd ff ff       	call   633 <write>
                while (*s != 0) {
 ...
 89c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 89f:	e8 8f fd ff ff       	call   633 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 9d3:	e8 3b fc ff ff       	call   613 <sbrk>
    if (p == (char*)-1) {
