...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 4de:	56                   	push   %esi
 4df:	57                   	push   %edi
 4e0:	e8 1e ff ff ff       	call   403 <write>
    while (--i >= 0) {
...
void printf(int fd, const char *fmt, ...) {
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 a7 fe ff ff       	call   403 <write>
 ...
 5ae:	e8 50 fe ff ff       	call   403 <write>
                putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 3d fe ff ff       	call   403 <write>
                putc(fd, c);
 ...
 62b:	57                   	push   %edi
 62c:	56                   	push   %esi
 62d:	e8 d1 fd ff ff       	call   403 <write>
                while (*s != 0) {
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
    write(fd, &c, 1);
 66f:	e8 8f fd ff ff       	call   403 <write>
                ap++;
...
void* malloc(uint nbytes) {
 ...
 7a3:	e8 3b fc ff ff       	call   3e3 <sbrk>
    if (p == (char*)-1) {
